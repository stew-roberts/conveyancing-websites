...
export default function Carousel({details}) {
    ...
    return (
        <div className="container mx-auto py-8">
            ...
            <div id="default-carousel" className='w-[50%] m-auto p-4'>
                <div className="overflow-hidden relative">
                    ...
                    <div className="absolute top-0 h-full w-full justify-between items-center flex text-base-500 px-5 text-2xl">
